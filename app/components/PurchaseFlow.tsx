            ...
            {user && globalSafewordVerified && !purchaseConfirmationData && (
                ...
                <div className="swap-silver-bar-row swap-silver-bar-row--inline">
                    ...
                    <select 
                        ...
                        className="swap-silver-bar-select purchase-swap-select p-2 rounded-md"
                    >
                    ...
                    <input
                        ...
                        className="swap-silver-bar-input purchase-swap-amount p-2 rounded-md custom-token-input"
                    />
                    </div>
                </div>
